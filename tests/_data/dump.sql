...
-- ----------------------------
BEGIN;
INSERT INTO `wp_usermeta` VALUES ('1', '1', 'wp_capabilities', 'a:1:{s:13:\"administrator\";b:1;}'), ('2', '1', 'wp_user_level', '10');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `wp_users` VALUES ('1', 'admin@test.dev', '9cdfb439c7876e703e307864c9167a15', 'admin', 'admin@test.dev', '', '2018-08-20 12:12:12', '', '0', 'test.dev', '0', '0');
COMMIT;
